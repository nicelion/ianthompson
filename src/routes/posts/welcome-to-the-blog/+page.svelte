...
<Article postData={data}>
    <Section title="Welcome">
        ...
        <Column>
            ...
            <Image src="https://storage.googleapis.com/iacthompson-dev-bucket/3_2d91ac0434/3_2d91ac0434.jpg" alt="A screenshot of the App Store provided screenshot of my first game: Click Quick!" slot="right"/>
        </Column>        
        <p>
        ...
        <Column>
            <Image src="https://storage.googleapis.com/iacthompson-dev-bucket/IMG_5660_8d1ac28c99/IMG_5660_8d1ac28c99.jpg" alt="2019 graduating seniors back on the elementary school's playground" slot="left"/>
