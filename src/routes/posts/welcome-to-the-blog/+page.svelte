	...
	<Section title="Welcome">
		...
		<Column>
			<ColumnContent slot="left">
				<p>
					It all started when I was in middle school. I began to develop a deep interest in
					computers and programming. I started out learning the Objective-C language, and by the
					time I was in 8th grade, I published my first application to the Apple App Store (of
					course, under my mom's name since you had to be 18 with a valid driver's license to
					publish!). From there, I went on to learn Swift, and by 10th grade, I published my second
		...
		<p>
			This deep interest and apparent skill in computer science would lead me to believe that I
			would go on to major in CS in college. Well, the Lord had different plans...
		</p>
		<Column>
			<Image
			...
			<ColumnContent slot="right">
				<p>
					...
					education. Teaching and sharing my knowledge have always interested me. So much so, while
					a middle and high schooler, I would frequently make programming tutorials on my YouTube
					channel. (I'm sure a few of these still exist somewhere on the internet). In my senior
					year of high school, I took a job at my old elementary school, working in the extended day
				...
				<p>
					...
					sounding overly clichè, the Lord works in mysterious ways. While in college, I began
